final Map<String, List<String>> categories = {
  ...
  "Con cái": ["Học phí", "Trông trẻ", "Sữa", "Bỉm", "Đồ chơi", "Tiền tiêu vặt"],
  "Trang phục": ["Quần áo", "Giầy dép", "Phụ kiện khác"],
  "Hiếu hỉ": ["Thăm hỏi", "Biếu tặng"],
  "Nhà cửa": ["Mua sắm đồ đạc", "Thuê nhà", "Thế chấp nhà", "Sửa chữa"],
  "Hưởng thụ": ["Vui trơi giải trí", "Du lịch", "Phim ảnh ca nhạc", "Spa & massage", "Mỹ phẩm", "Nhậu nhẹt"],
